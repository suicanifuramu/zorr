...
// Pinky bit: bot previously hardcoded 2048 inside its status flag display list.
// The game's flag with that name in the client status list is exported for parity; kept
// overridable via sharedData for the account manager's detection regex.
export const PINKY_BITMASK = 2048;
