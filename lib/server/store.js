...
const ROOT = path.join(__dirname, "..", ".."); // project root — config files live here
...
const TRACKING_CONFIG_PATH = path.join(ROOT, "tracking_config.json");
...
const PING_RULES_PATH = path.join(ROOT, "ping_rules.json");
let pingRules = { rules: [] };
try {
...
const BIOME_CHANNELS_PATH = path.join(ROOT, "biome_channels.json");
