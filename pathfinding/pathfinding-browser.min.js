            ...
            6: [
                function (t, e, r) {
                    ...
                    function a(t) {
                        ...
                        for (o = 0; h - 1 > o; ++o)
                            for (
                                e = t[o], r = t[o + 1], i = s(e[0], e[1], r[0], r[1]), n = i.length, a = 0;
                                n - 1 > a;
                                ++a
                            )
                                u.push(i[a]);
                ...
                function (t, e) {
                    ...
                    ((r.prototype.findPath = function (t, e, r, o, s) {
                        var a,
                            ...
                            C = 2;
                        for (
                            A.g = 0, A.f = 0, b.push(A), A.opened = N, k.g = 0, k.f = 0, y.push(k), k.opened = C;
                            !b.empty() && !y.empty();
                        ) {
                            for (
                                a = b.pop(), a.closed = !0, u = s.getNeighbors(a, v, w), l = 0, p = u.length;
                                p > l;
                                ++l
                            )
                                if (((h = u[l]), !h.closed)) {
                            ...
                            for (
                                a = y.pop(), a.closed = !0, u = s.getNeighbors(a, v, w), l = 0, p = u.length;
                                p > l;
                                ++l
                            )
                                if (((h = u[l]), !h.closed)) {
                ...
                function (t, e) {
                    ...
                    ((r.prototype.findPath = function (t, e, r, n, o) {
                        var s,
                            ...
                            A = 1;
                        for (
                            f.push(p), p.opened = !0, p.by = y, d.push(c), c.opened = !0, c.by = A;
                            f.length && d.length;
                        ) {
                            for (
                                u = f.shift(), u.closed = !0, s = o.getNeighbors(u, g, b), h = 0, l = s.length;
                                l > h;
                                ++h
                            )
                                if (((a = s[h]), !a.closed))
                            ...
                            for (
                                u = d.shift(), u.closed = !0, s = o.getNeighbors(u, g, b), h = 0, l = s.length;
                                l > h;
                                ++h
                            )
                                if (((a = s[h]), !a.closed))
                    ...
                    ((r.prototype.findPath = function (t, e, r, n, o) {
                        ...
                        for (p.push(d), d.opened = !0; p.length;) {
                            ...
                            for (s = o.getNeighbors(u, c, f), h = 0, l = s.length; l > h; ++h)
                                ((a = s[h]), a.closed || a.opened || (p.push(a), (a.opened = !0), (a.parent = u)));
                        }
                        return [];
                    }),
                        (e.exports = r));
                ...
                function (t, e) {
                    ...
                    ((r.prototype.findPath = function (t, e, r, o, s) {
                        ...
                        (r.prototype._jump = function (t, e, r, i) {
                            ...
                            if (
                                (this.trackJumpRecursion === !0 && (n.getNodeAt(t, e).tested = !0),
